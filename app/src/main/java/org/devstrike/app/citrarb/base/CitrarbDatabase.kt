 ...
 */
@Database(entities = [SavedNewsListData::class, Friend::class, Event::class, Connect::class], version = 1, exportSchema = false)
...
abstract class CitrarbDatabase : RoomDatabase() {
    ...
    abstract fun getConnectListDao(): ConnectDao
